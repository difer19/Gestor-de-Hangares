...
################################################################################
## Form generated from reading UI file 'ReporteUsuarios.ui'
##
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"Reporte de Usuarios", None))
        ...
        ___qtablewidgetitem.setText(QCoreApplication.translate("Form", u"Id Usuario", None));
        ___qtablewidgetitem1 = self.tableWidget.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("Form", u"UserName", None));
        ___qtablewidgetitem2 = self.tableWidget.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("Form", u"Afiliacion", None));
        ___qtablewidgetitem3 = self.tableWidget.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("Form", u"Nombre", None));
        self.label_3.setText(QCoreApplication.translate("Form", u"Reporte Total", None))
        ...
        ___qtablewidgetitem4.setText(QCoreApplication.translate("Form", u"Aerolinea", None));
        ___qtablewidgetitem5 = self.tableWidget_2.horizontalHeaderItem(1)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("Form", u"Cantidad de Usuarios", None));
    # retranslateUi
